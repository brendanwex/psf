...
<div class="cover">
    <h1>Exception
        <small>in <?php echo $e->getFile() . ":" . $e->getLine(); ?></small>
    </h1>
    <?php
    echo "<pre style='text-align: left; width:60%; margin:auto;border:1px solid#fff;padding:15px;'>";
    print_r($e);
...
<footer><p>PHP Simple Framework | Version : <?php echo SF_VERSION; ?></p></footer>
</body>
</html>
